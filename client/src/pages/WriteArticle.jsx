...
const WriteArticle = () => {
  ...
  const onSubmitHandler = async(e) => {
    ...
    try {
      setLoading(true)
      const prompt = `Write a detailed and comprehensive article about ${input} in ${selectedLength.length} words.`
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <br />
        <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#226BFF] to-[#65BDFF] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
         ...
         {!content ? (
          ...
          <div className='mt-3 text-sm h-full overflow-y-scroll text-slate-600'>
